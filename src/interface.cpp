...
Fl_Button * loadCamera_button = (Fl_Button *)0;
...
Fl_Window * make_window() 
{
  Fl_Window * w;
  { 
    Fl_Window * o = main_window = new Fl_Window(741, 622, "pose3D");
    w = o;
    { 
      ...
      {
        Fl_Button  *  o = loadCamera_button = new Fl_Button(270,495,120,40,"Load Camera");
        o->callback((Fl_Callback *)load_callback);
      }

      // "Reload motion" always reload the last skeleton loaded
      { 
        Fl_Button * o = reloadMotion_button = new Fl_Button(400, 495, 120, 40, "Reload Motion");
        o->callback((Fl_Callback *)reload_callback);
      }

      { 
        Fl_Button * o = resetScene_button = new Fl_Button(530, 495, 120, 40, "Reset Scene");
